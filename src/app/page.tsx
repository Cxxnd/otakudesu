...
export default function Home() {
  ...
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: "4rem 1.5rem" }}>
      ...
      <h1
        style={{ fontSize: "2.5rem", lineHeight: 1.1, margin: "0.5rem 0 1rem" }}
      >
        Otakudesu API
      </h1>
      <p
      ...
      >
        A read-only public API for anime, comics, movies and Indonesian live TV.
      ...
      <p style={{ color: "var(--muted)", fontSize: "0.9rem" }}>
        This project indexes and links to third-party sources. It hosts no media
        of its own.{" "}
        <a href="https://github.com/Cxxnd/otakudesu">Source on GitHub</a>.
      </p>
    </main>
  );
}
