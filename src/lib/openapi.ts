...
const OPERATIONS: Op[] = [
...

    {
        ...
        summary:
            "Official Muse Indonesia playlist matching an anime title, when one exists",
        tag: "Anime",
        params: [
            {
                name: "title",
    ...
    },
    {
        ...
        summary:
            "Reader payload: ordered page images plus prev/next navigation",
        tag: "Comic",
        params: [
            {
                name: "slug",
...

    {
        ...
        summary:
            "Indonesian radio stations that passed the upstream liveness check",
        tag: "Radio",
        params: [
            {
                name: "tag",
...

    {
        ...
        summary:
            "Shinigami's current domain, resolved live from their own link portal",
        tag: "Comic",
    },

    {
        path: "/api/v1/search",
        summary:
            "Cross-domain search — anime, comics, movies/TV and radio in one call",
        tag: "Search",
        params: [
            {
                name: "q",
    ...
    },
    {
        ...
        summary:
            "Reverse image search — which anime a screenshot is from (GET by URL, POST an upload)",
        tag: "Tools",
        params: [
            {
                name: "url",
    ...
    },
    {
        ...
        summary:
            "OP/ED theme songs for a title, matched by name, with direct playable audio",
        tag: "Tools",
        params: [
            {
                name: "title",
