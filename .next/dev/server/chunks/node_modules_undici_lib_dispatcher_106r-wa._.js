...
class BalancedPool extends PoolBase {
    constructor(upstreams = [], { factory = defaultFactory, connect, tls, ...opts } = {}){
        ...
        if (tls && typeof tls !== 'function') tls = {
            ...tls
        };
        this[kOptions] = {
            ...util.deepClone(opts),
...
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { RequestContentLengthMismatchError, RequestAbortedError, SocketError, InformationalError, InvalidArgumentError, HeadersTimeoutError, BodyTimeoutError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { kUrl, kReset, kClient, kRunning, kPending, kQueue, kPendingIdx, kRunningIdx, kError, kSocket, kStrictContentLength, kOnError, kMaxConcurrentStreams, kPingInterval, kHTTP2Session, kHTTP2InitialWindowSize, kHTTP2ConnectionWindowSize, kResume, kSize, kHTTPContext, kClosed, kBodyTimeout, kHeadersTimeout, kEnableConnectProtocol, kRemoteSettings, kHTTP2Stream, kHTTP2SessionState } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
