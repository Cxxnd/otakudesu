import { applyColorMode, getSystemColorMode } from '../theme/color-mode.js';
import { applyThemeVariant, defaultThemeVariant, themeVariants } from './themes.js';
/**
 ...
 * is running them.
 */
export const defaultColorMode = getSystemColorMode();
/**
 ...
 * preview loads.
 */
export const applyScalarGlobals = (globals) => {
    applyThemeVariant(globals.theme);
